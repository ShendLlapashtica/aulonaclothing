...
import { useOrders, useShippingRates, useUpdateOrderStatus } from "@/lib/store";
import { Flag } from "@/components/flag";
import { useState } from "react";
import { ChevronDown, Phone, MapPin, MessageSquare, Package } from "lucide-react";
            ...
            return (
              <div key={o.id}>
                <button
                  ...
                  className="w-full grid grid-cols-[auto_1fr_auto] sm:grid-cols-[auto_1fr_auto_auto_auto] gap-3 sm:gap-5 items-center px-4 sm:px-5 py-4 text-left hover:bg-secondary/40 transition-colors"
                >
                  <ChevronDown
                  ...
                  <span
                    className={`justify-self-end inline-block px-2.5 py-1 text-[10px] tracking-widest uppercase ${statusColor[o.status] || "bg-secondary"}`}
                  >
                    {o.status}
                  </span>
                </button>
